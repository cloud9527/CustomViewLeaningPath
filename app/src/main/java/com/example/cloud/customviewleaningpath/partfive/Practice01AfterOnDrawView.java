package com.example.cloud.customviewleaningpath.partfive;
...
public class Practice01AfterOnDrawView extends AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            ...
            canvas.drawText(getResources().getString(R.string.image_size, bounds.width(), bounds.height()), 50, 40, paint);
            canvas.restore();
        }
    }
}