package com.example.cloud.customviewleaningpath.partThree;
...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text2, 50 + mMeasuredText1, 200, paint2);
        canvas.drawText(text3, 50 + mMeasuredText2 + mMeasuredText1, 200, paint1);
    }
}
