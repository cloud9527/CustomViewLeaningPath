...
import com.example.cloud.customviewleaningpath.partfive.PageFragmentFive;

import java.util.ArrayList;
import java.util.List;

public class PartFiveActivity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pager.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                return PageFragmentFive.newInstance(pageModel.sampleLayoutRes, pageModel.practiceLayoutRes);
            }
